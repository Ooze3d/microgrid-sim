...
echo "=== Switching simulator network to CEN ==="

# -------------------------------------------------------------------
# 1. Remove known Virgen del Camino simulator aliases
# -------------------------------------------------------------------
...
echo
echo "Removing Virgen del Camino simulator IPs..."
...
# -------------------------------------------------------------------
# 2. Add CEN simulator aliases
# -------------------------------------------------------------------

CEN_SIM_IPS=(
  "192.168.52.8/24"    # Breaker sotano
  "192.168.52.32/24"   # NSX acometida 1
  "192.168.52.33/24"   # NSX acometida 2
  "192.168.52.34/24"   # PM acometida 1
  "192.168.52.35/24"   # PM acometida 2
  "192.168.52.69/24"   # BMS
  "192.168.52.70/24"   # PCS
)

echo
echo "Adding CEN simulator IPs..."
...
echo
echo "CEN simulator network ready."